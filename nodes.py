...
class DownloadAndLoadHyVideoTextEncoder:
    ...
    def INPUT_TYPES(s):
        ...
        return {
            ...
            "optional": {
                ...
                "norm_strength": ("FLOAT", {"default": 0.5, "min": 0.0, "max": 1.0, "step": 0.1}),  # Add slider for norm_strength
            }
        }
    ...
    def loadmodel(self, llm_model, clip_model, precision, apply_final_norm=False, hidden_state_skip_layer=2, use_prompt_templates=True, quantization="disabled", norm_strength=0.5):
